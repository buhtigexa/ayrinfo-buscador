...
public  class SimpleCocoQuery extends CocoQuery {
	...
	public SimpleCocoQuery(Version matchVersion,String fieldToSearch,Analyzer analyzer,String lookFor,String prefix,String sufix){
		...
		tokenizer = new StringTokenizer(lookFor," ? ! ¿ ¡ ' \\` ~. ; : * @     °| { [ ] < />- + , · # = ) - _ ( / & % $ #¨    ");
		terms = new String();
	...
	public Query buildQuery () {
		...
		try {
			   query = queryParser.parse(this.tokenize());
			} 
				catch (ParseException e) { 	e.printStackTrace();	}
		
//			System.out.println("----Parsed final query  :" + query.toString());
			return query;
	}
...
//		System.out.println(" ---- Assembled query :"   +   stringParsed);
		return  stringParsed;
	}
