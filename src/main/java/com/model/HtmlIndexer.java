...
public class HtmlIndexer extends CocoIndexer {
	    ...
	    public HtmlIndexer(Analyzer analyzer,String indexDir, String dataDir, CocoFileFilter fileFilter) {
...
//							Elements summary = jsoupDoc.select("pre").eq(1);
							...
							try{ 		
//								int numero = Integer.parseInt(year); 
							}
